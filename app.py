...
languages = {
    ...
    "Español": {"title": "🤖 ReviewAI Pro", "subtitle": "Generador de reseñas", "task": "Tarea", "style": "Estilo", "details": "Detalles", "btn": "GENERAR ✨", "opt1": "Escribir reseña (cliente)", "opt2": "Responder a reseña (dueño)"}
}

# 3. Кастомный CSS (оформление не меняем, как ты и просил)
st.markdown("""
    <style>
...
with col1:
    ...
    # Динамический плейсхолдер (твой запрос!)
    if action == t["opt1"]:
    ...
    if generate_btn:if text_input:
            with st.spinner('🔮 AI is working...'):
                try:
                    ...
                    final_text = response.choices.message.content
